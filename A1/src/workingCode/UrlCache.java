...
public class UrlCache {
	...
	/**
	 * Creates a catalog file called catalog.txt in the local directory if there
	 * is not already an existing file in the local directory
	 */
	...
	public void beginDownloadStream(Host host, boolean exists)
			throws UrlCacheException {
		try {
			...
			host.setPath(host.getHostName() + host.getConcatPath());

			writeToFile(host.getPath(), host.getFileName(), inStream);
